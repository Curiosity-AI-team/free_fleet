...
static const uint32_t FreeFleetData_Location_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_1BY, offsetof (FreeFleetData_Location, obey_approach_speed_limit),
  DDS_OP_ADR | DDS_OP_TYPE_8BY | DDS_OP_FLAG_FP, offsetof (FreeFleetData_Location, approach_speed_limit),
  DDS_OP_RTS
};
...
static const uint32_t FreeFleetData_RobotState_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_1BY, offsetof (FreeFleetData_RobotState, location.obey_approach_speed_limit),
  DDS_OP_ADR | DDS_OP_TYPE_8BY | DDS_OP_FLAG_FP,offsetof (FreeFleetData_RobotState, location.approach_speed_limit),
  ...
  DDS_OP_ADR | DDS_OP_TYPE_1BY,
    offsetof(FreeFleetData_Location, obey_approach_speed_limit),
  DDS_OP_ADR | DDS_OP_TYPE_8BY | DDS_OP_FLAG_FP,
    offsetof(FreeFleetData_Location, approach_speed_limit),
  DDS_OP_RTS,
  DDS_OP_RTS
};
...
static const uint32_t FreeFleetData_DestinationRequest_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_1BY,              offsetof (FreeFleetData_DestinationRequest, destination.obey_approach_speed_limit),
  DDS_OP_ADR | DDS_OP_TYPE_8BY | DDS_OP_FLAG_FP,offsetof (FreeFleetData_DestinationRequest, destination.approach_speed_limit),
...
static const uint32_t FreeFleetData_TaskRequest_ops [] =
{
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_TaskRequest, fleet_name),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_TaskRequest, robot_name),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_TaskRequest, task_id),
  DDS_OP_ADR | DDS_OP_TYPE_STR, offsetof (FreeFleetData_TaskRequest, task_type),
  DDS_OP_RTS
};

const dds_topic_descriptor_t FreeFleetData_TaskRequest_desc =
{
  sizeof (FreeFleetData_TaskRequest),
  sizeof (char *),
  DDS_TOPIC_NO_OPTIMIZE,
  0u,
  "FreeFleetData::TaskRequest",
  NULL,
  5,
  FreeFleetData_TaskRequest_ops,
  "<MetaData version=\"1.0.0\"><Module name=\"FreeFleetData\"><Struct name=\"TaskRequest\"><Member name=\"fleet_name\"><String/></Member><Member name=\"robot_name\"><String/></Member><Member name=\"task_id\"><String/></Member><Member name=\"task_type\"><String/></Member></Struct></Module></MetaData>"
};
