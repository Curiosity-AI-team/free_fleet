...
typedef struct FreeFleetData_TaskRequest
{
  char * fleet_name;
  char * robot_name;
  char * task_id;
  char * task_type;
} FreeFleetData_TaskRequest;

extern const dds_topic_descriptor_t FreeFleetData_TaskRequest_desc;

#define FreeFleetData_TaskRequest__alloc() \
((FreeFleetData_TaskRequest*) dds_alloc (sizeof (FreeFleetData_TaskRequest)));

#define FreeFleetData_TaskRequest_free(d,o) \
dds_sample_free ((d), &FreeFleetData_TaskRequest_desc, (o))
